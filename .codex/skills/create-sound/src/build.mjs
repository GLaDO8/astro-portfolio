...
const meta = JSON.parse(await readFile(join(SKILL_ROOT, "metadata.json"), "utf8"));
...
lines.push("");
lines.push(`> Generated from \`rules/*.md\` by \`src/build.mjs\`. Do not edit by hand.`);
lines.push("");
lines.push("Pick a generation path with `pipeline-detect-input`, then walk the matching section.");
lines.push("");
