...
export default function HeroSection() {
  ...
  return (
    <section className="w-full flex flex-col items-start gap-6">
      <h1 className="font-serif font-semibold text-2xl leading-[1.2] m-0 text-pretty">
      ...
      <div className="flex gap-6 items-center">
        <button
          type="button"
          onClick={cycle}
          className="bg-white rounded-full px-5 py-1.5 font-sans font-semibold text-base tracking-[-0.02em] text-text-secondary shadow-[0px_0px_8px_0px_rgba(88,104,110,0.15)] cursor-pointer hover:shadow-[0px_0px_12px_0px_rgba(88,104,110,0.25)] transition-[box-shadow,transform] active:scale-[0.97]"
        >
          What else ?
        </button>
        ...
        <a
          ...
          className="text-text-hero hover:text-text-secondary transition-[color,transform] active:scale-[0.97]"
        >
          <svg
            width="28"
            height="28"
